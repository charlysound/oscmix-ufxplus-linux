...
static const struct channelinfo inputs[] = {
	{"Analog 1",  INPUT_HAS_GAIN | INPUT_HAS_REFLEVEL, .gain={0, 12}, .reflevel={reflevel_input, LEN(reflevel_input)}},
	{"Analog 2",  INPUT_HAS_GAIN | INPUT_HAS_REFLEVEL, .gain={0, 12}, .reflevel={reflevel_input, LEN(reflevel_input)}},
	{"Analog 3",  INPUT_HAS_GAIN | INPUT_HAS_REFLEVEL, .gain={0, 12}, .reflevel={reflevel_input, LEN(reflevel_input)}},
	{"Analog 4",  INPUT_HAS_GAIN | INPUT_HAS_REFLEVEL, .gain={0, 12}, .reflevel={reflevel_input, LEN(reflevel_input)}},
	{"Analog 5",  INPUT_HAS_GAIN | INPUT_HAS_REFLEVEL, .gain={0, 12}, .reflevel={reflevel_input, LEN(reflevel_input)}},
	{"Analog 6",  INPUT_HAS_GAIN | INPUT_HAS_REFLEVEL, .gain={0, 12}, .reflevel={reflevel_input, LEN(reflevel_input)}},
	{"Analog 7",  INPUT_HAS_GAIN | INPUT_HAS_REFLEVEL, .gain={0, 12}, .reflevel={reflevel_input, LEN(reflevel_input)}},
	{"Analog 8",  INPUT_HAS_GAIN | INPUT_HAS_REFLEVEL, .gain={0, 12}, .reflevel={reflevel_input, LEN(reflevel_input)}},
	{"Mic/Inst 9",  INPUT_HAS_GAIN | INPUT_HAS_48V | INPUT_HAS_AUTOSET | INPUT_HAS_HIZ, .gain={0, 75, 8, 50}},
	{"Mic/Inst 10", INPUT_HAS_GAIN | INPUT_HAS_48V | INPUT_HAS_AUTOSET | INPUT_HAS_HIZ, .gain={0, 75, 8, 50}},
	{"Mic/Inst 11", INPUT_HAS_GAIN | INPUT_HAS_48V | INPUT_HAS_AUTOSET | INPUT_HAS_HIZ, .gain={0, 75, 8, 50}},
	{"Mic/Inst 12", INPUT_HAS_GAIN | INPUT_HAS_48V | INPUT_HAS_AUTOSET | INPUT_HAS_HIZ, .gain={0, 75, 8, 50}},
	{"AES L"}, {"AES R"},
